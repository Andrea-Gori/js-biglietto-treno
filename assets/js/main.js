...
if (eta < 18) {
  alert('Il prezzo del suo biglietto è:' + (biglietto - (biglietto * 0.20)).toFixed(2) + ' €');
  console.log('Il prezzo del suo biglietto è: ' + (biglietto - (biglietto * 0.20)).toFixed(2) + ' €');
} else if (eta > 65) {
  alert('Il prezzo del suo biglietto è:' + (biglietto - (biglietto * 0.40)).toFixed(2) + ' €')
  console.log('Il prezzo del suo biglietto è: ' + (biglietto - (biglietto * 0.40)).toFixed(2) + ' €');
} else {
  alert('Il prezzo del suo biglietto è:' + biglietto.toFixed(2) + '€')
